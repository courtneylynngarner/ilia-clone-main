        ...
        <div onClick={shadeClickHandler} className="shade-container">
          ...
          <div className="product-info-drop-down-container">
            ...
            <p className="product-text">
              ...
              skin from UVA, UVB, UVC, blue light and infrared rays. Created
              with a blend of Hyaluronic Acids, plant-based Squalane, and
              Niacinamide, ILIA's Skin Tint evens tone, softens fine lines and
              imperfections, and dries down to a natural, dewy finish. And this
              super serum doesn’t stop there: it also creates a natural barrier
              for your skincare—sealing in hydration, plumping skin, and
              boosting any antioxidant effectiveness by 200%. Plus, it’s
              silicone-free, fragrance-free, chemical screen-free, oil-free,
              non-comedogenic, and safe for sensitive skin. This is SPF, made
              super.
            </p>
            ...
            <p className="product-info">
              ...
              Propanediol, Isopropyl Isostearate, Polyglyceryl-3 Diisostearate,
              Methylpropanediol, Niacinamide, Sodium Chloride, Lecithin,
              Caprylyl Glycol, Silica, Aloe Barbadensis Leaf Juice Powder,
              Bisabolol, Hydrolyzed Sodium Hyaluronate, Allantoin,
              Phenylpropanol, Sodium Myristoyl Glutamate, Sodium Hyaluronate,
              Tetrasodium Glutamate Diacetate, Aluminum Hydroxide,
              Polyhydroxystearic Acid. May Contain/Peut Contenir (±): CI 77491,
              CI 77492, CI 77499 (Iron Oxides), CI 77891 (Titanium Dioxide).
            </p>
